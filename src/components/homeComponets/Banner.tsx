        ...
        <Carousel autoplay>
          ...
          <div className="relative">
            <img
              src={sliderImage1}
              alt="Shop About"
              className="w-full h-[500px] md:h-[600px] object-cover rounded"
            />
            {/* Top Text */}
            <motion.div
            ...
            <motion.div
              className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-black bg-opacity-60 text-white p-4 md:p-6 rounded max-w-xs md:max-w-lg text-center"
              initial="hidden"
              animate="visible"
